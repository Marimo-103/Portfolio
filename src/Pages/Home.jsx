    ...
    <div className='bg-[#171717] rounded-bl-[10px] rounded-br-[10px] md:rounded-bl-[14px] md:rounded-br-[14px]'>
      ...
      <section id='intro' className='pt-12 md:px-5 px-2'>
        <div className="main">
          ...
          <span className='text-2xl md:text-4xl'>H</span>ello, I'm <div className='text-[#DCCA87] md:text-xl text-lg font-semibold tracking-[0.32px] inline-block font-Outfit'>Mahmudul Hasan</div>! A passionate Web Developer and Designer with a knack for creating dynamic and responsive web applications. <br /><br />
      ...
      {/* testimonials */}
      <section id="testimonials" className='md:pt-20 pb-2 md:pb-4 py-12 md:px-5 px-2'>
        <div className="main">
